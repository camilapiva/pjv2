...
<head>
  ...
  <title>Administração | Inicio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg" style="font-size:70%" ><b>Administração</b> - E-commerce</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/res/site/img/userft.png" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Abrace um Pet - Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="/res/site/img/userft.png" class="img-circle" alt="User Image">

                <p>
                  Abrace um Pet - Admin
                  <small>Membro desde Novembro de 2019</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
