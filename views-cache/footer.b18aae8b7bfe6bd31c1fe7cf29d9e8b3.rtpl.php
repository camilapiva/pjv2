<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Main Footer -->
  <footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
      E-commerce Abrace um Pet
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="#">Abrace um Pet</a>.</strong> Todos os Direitos Reservados.
  </footer>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:;">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Aniversário de Jessica</h4>

                <p>Será 23 em 24 de abril</p>
              </div>
            </a>
          </li>
        </ul>
